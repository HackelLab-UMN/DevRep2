...
class model_plot():
    ...
    def __init__(self):
        self.fig, self.ax = plt.subplots(2,1,figsize=[1.25,2.5],dpi=1200)
...
class x_to_yield_plot(model_plot):
    ...
    def __init__(self,model):
        ...
        # self.ax[0].scatter(iq_data[0], iq_data[1],s=8,marker='.',color='maroon',alpha=0.05,label='LysY/$I^q$')
        # self.ax[0].scatter(sh_data[0], sh_data[1],s=8,marker='.',color='orange',alpha=0.05,label='SHuffle')
