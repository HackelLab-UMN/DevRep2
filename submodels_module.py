...
class x_to_yield_model(model):
    ...
    def limit_test_set(self,assays):
        ...
        sort_names=[]
        for i in assays:
            sort_names.append('Sort'+str(i)+'_mean_count')
    ...
    def apply_predicted_assay_scores(self,seq_to_assay_model_prop):
        ...
        self.limit_test_set([1,8,10])
        print(len(self.testing_df))
...
class seq_to_pred_yield_model(x_to_yield_model,seq_to_x_model):
    ...
    def __init__(self, pred_yield_model_prop, seq_to_pred_yield_prop, use_seq=False):
        ...
        pred_yield_model_name='assays'+self.assay_str+'_yield_'+pred_yield_model_prop[1]+'_'+str(pred_yield_model_prop[2])+'_'+str(pred_yield_model_prop[3]) #change for seq and assay
